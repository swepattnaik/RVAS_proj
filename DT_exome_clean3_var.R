...
for(j in 1:dim(var_maf_df)[1]){
  ...
  MAF_case <- sum(sam_var_vec)/1108
  MAF_control <- (length(sam_var_vec) - MAF_case)/2172
...
Ex_tab_noCH_filt3_fin_filt$MAF_case <- ifelse((is.na(Ex_tab_noCH_filt3_fin_filt$MAF_case) 
                                              ...
                                              1/1108, Ex_tab_noCH_filt3_fin_filt$MAF_case)
Ex_tab_noCH_filt3_fin_filt$MAF_control <- ifelse((is.na(Ex_tab_noCH_filt3_fin_filt$MAF_control) 
                                                 ...
                                                 1/2172, Ex_tab_noCH_filt3_fin_filt$MAF_control)
...
Ex_tab_noCH_filt3_fin_filt$set <- c("discovery")
...
write.table(Ex_tab_noCH_filt3_fin_filt[,-c(40,41)], file = "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/discovery_set/Disc_set_variants_filt_all.tsv",
