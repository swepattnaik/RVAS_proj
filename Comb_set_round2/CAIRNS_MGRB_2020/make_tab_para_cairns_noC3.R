...
`%nin%` = Negate(`%in%`)
fil_tab <- read.delim("~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/CAIRNS/all_cairns_mgrb_combset2020_variants_filt_all_fields_rmdup_fin.tsv",
            sep = "\t", header = T, stringsAsFactors = F)
...
saveRDS(res20, "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/CAIRNS/Exome_para_pc123_SKAT_Enriched_CAIRNS_2020_minusC3.rds", compress = T)
