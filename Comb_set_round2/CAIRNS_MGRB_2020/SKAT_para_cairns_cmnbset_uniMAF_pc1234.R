...
saveRDS(res_skat_para, file = "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/CAIRNS/Exome_skat_para_result_CAIRNS_combset2020_uni_MAF_PC1234_ver4.rds", compress = T)
