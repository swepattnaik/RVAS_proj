...
#  print(genes[i])
  ...
  if(dim(ftemp_tab)[1] == 0 ){
    ...
    ## change to MAF filter to 3/((413 + 3205)*2)
...
saveRDS(res_skat_para, file = "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/CAIRNS/round2/ASRB_AR_AD/SKAT/Exome_skat_para_result_CAIRNS_combset2020_uni_MAF_PC1234_ver4.rds", compress = T)
