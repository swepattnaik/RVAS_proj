...
write.table(Ex_tab_noCH_filt3_fin_filt, file = "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/CAIRNS/round2/ASRB_AR_AD/all_ASRB_combset2020_variants_AR_AD_all_fields_clingene_rnd3.tsv",
            row.names = F, quote = F, sep = "\t")
