...
#            sep = "\t", row.names = F, quote = F)
write.table(genes, "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/ISKS/round2/CGC_topSKATBin300_repstress_potint_PID_unique_genes_rmdup_maf_cluego_june1.txt",
            sep = "\t", row.names = F, quote = F)
...
#            sep = "\t", row.names = F, quote = F)
#write.table(comb_set_filt1, "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/ISKS/round2/CGC_topSKATBin300_repstress_potint_VARIANTS_filt_combset2020_rmdup_maf_clueGO_plusMay31.tsv",
#            sep = "\t", row.names = F, quote = F)
write.table(comb_set_filt1, "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/ISKS/round2/CGC_topSKATBin300_repstress_potint_VARIANTS_filt_combset2020_rmdup_maf_clueGO_plusJune1.tsv",
            sep = "\t", row.names = F, quote = F)
...
#            sep = "\t", row.names = F, quote = F)
# write.table(comb_ALL_phen_filt[,-c(74:80)], 
#             "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/ISKS/round2/PID_combset2020_CGC_skatBin_repstress_potint_predNFE_rmdup_maf_clueGO_Apr292020.tsv",
#             sep = "\t", row.names = F, quote = F)
#write.table(comb_ALL_phen_filt[,-c(74:80)], 
#            "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/ISKS/round2/PID_combset2020_CGC_skatBin_repstress_potint_predNFE_rmdup_maf_clueGO_Apr292020_May31.tsv",
#            sep = "\t", row.names = F, quote = F)
write.table(comb_ALL_phen_filt[,-c(74:80)], 
            "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/ISKS/round2/PID_combset2020_CGC_skatBin_repstress_potint_predNFE_rmdup_maf_clueGO_Apr292020_June1.tsv",
            sep = "\t", row.names = F, quote = F)