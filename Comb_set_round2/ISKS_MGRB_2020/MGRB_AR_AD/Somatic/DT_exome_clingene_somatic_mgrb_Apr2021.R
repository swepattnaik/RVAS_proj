...
write.table(Ex_tab_noCH_filt3_fin_filt, file = "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/MGRB/Somatic/all_mgrb_somatic_variants_AR_AD_all_fields_clingene_rnd3_freeze.tsv",
            row.names = F, quote = F, sep = "\t")
