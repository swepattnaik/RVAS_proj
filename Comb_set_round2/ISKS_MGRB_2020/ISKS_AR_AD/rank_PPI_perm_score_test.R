...
ISKS_MGRB_2020_rnd3 <- read.delim("~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/ISKS_AR_AD/all_isksmgrb_skatinp_combset2020_clin_C3C4C5_NFE0002_AD_all_fields_rnd3.tsv",
                                  sep = "\t", header = T, stringsAsFactors = F)

ppi_res_fil_final <- read.delim("~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/ISKS_AR_AD/SKAT/ppi_res_fil_final_SKATbin_comb_str_biog.tsv", sep = "\t", header = T)
...
ppi_res_fil_final[ppi_res_fil_final$degree_str == 0,]$PPI_p_val_wt_str <- sample(seq(0.6, 0.9, 0.0001), size = 267, replace = F)
ppi_res_fil_final[ppi_res_fil_final$degree_str_biog == 0,]$PPI_p_val_wt_str_biog <- sample(seq(0.6, 0.9, 0.0001), size = 169, replace = F)
...
ppi_res_fil_final[,41:46] <- res20_df_comb[match(ppi_res_fil_final$gene, res20_df_comb$gene),c(4:5,10:11,16:17)]
...
write.table(ppi_res_fil_final[,c(1:12,14,17:20,22,26:28,32:34,38:55)], "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/ISKS_AR_AD/SKAT/scrambled_null_ppi_fisher_res_fil_final.tsv",
            sep = "\t", row.names = F, quote = F)
