...
mat_GRM <- readRDS("~/RVAS/comb_set_2020/PC_relate/ldpruned/MGRBISKS_1000G/GRM_KIN_ISKS_MGRB_1000G.rds")
...
pcair_vec = readRDS("~/RVAS/comb_set_2020/PC_relate/ldpruned/MGRBISKS_1000G/ISKSMGRB_1000G.combset2020.repset_filt.SNPtier12.match.vqsr.minrep.locusannot.WGSqc2.ldpruned.pcair.rds")
pcair_vec_dat = pcair_vec$auto$vectors
GRM_samp = read.delim("~/RVAS/comb_set_2020/PC_relate/ldpruned/MGRBISKS_1000G/ISKSMGRB_1000G_samp.txt", sep="", header= F, stringsAsFactors=F)
rownames(pcair_vec_dat) = as.character(GRM_samp$V1)
...
res20 <- list()
genes <- unique(fil_tab$gene_symbol)
# genes = c("POT1", "TINF2", "TERF1", "TERF2", "TERF2IP", "SMARCAL1", "STAG3",
#           "TIMELESS", "CEP63", "CEP72", "HAUS4", "HAUS5", "MZT1", "SSNA1",
#           "NF1", "LZTR1", "SDHA", "SDHB", "SDHC", "SDHD", "TP53", "BRCA2",
#           "BRCA1", "PALB2")
...
saveRDS(res20, file = "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/ISKS_AR_AD/review_doc/SKAT/Exome_skat_para_result_isks_totex_count_pcair1234_subPC1_kinEMMAX_1000G.rds", compress = T)
#saveRDS(res20, file = "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/ISKS_AR_AD/review_doc/SKAT/Exome_skat_para_result_isks_totex_count_pcair1234_subPC1_kinEMMAX_1000G_cpxgenes.rds", compress = T)
