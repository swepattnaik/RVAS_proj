...
##Add GCTA GRM with 1000G
  mat_GRM <- readRDS("~/RVAS/comb_set_2020/PC_relate/ldpruned/MGRBISKS_1000G/GCTA_GRM_ISKS_MGRB_1000G.rds")
  print(dim(mat_GRM))
  ...
  colnames(mat_GRM) = as.character(GRM_samp$V1)
  rownames(mat_GRM) = as.character(GRM_samp$V1)
...
mat_GRM_rect <- mat_GRM_rect[p_Data_noCH$rect_sam,]
#saveRDS(mat_GRM_rect, "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/ISKS_AR_AD/review_doc/mat_GCTA_GRM_rect.rds", compress = T)
...
#res20_df = do.call("rbind.data.frame", res20)
#for centrosome and shelterin complex genes
#saveRDS(res20, file = "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/ISKS_AR_AD/review_doc/SKAT/Exome_skat_para_result_isks_totex_count_noPC1234_ver4_clinrect_Aug31_subPC1_1000GgrmGCTA_cpxgenes.rds", compress = T)
saveRDS(res20, file = "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/ISKS_AR_AD/review_doc/SKAT/Exome_skat_para_result_isks_totex_count_noPC1234_ver4_clinrect_Aug31_subPC1_1000GgrmGCTA.rds", compress = T)
##sanity checks
