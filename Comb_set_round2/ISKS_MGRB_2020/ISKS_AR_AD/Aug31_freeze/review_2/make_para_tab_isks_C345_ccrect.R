...
get_coh_dist_para <- function(gene_sym, fil_db){
  ...
  if(length(ftemp_tab_var_id) == 0 ){ ##added on apr.22
    ...
    for(m in 1:length(ftemp_tab_var_id)){
      ...
      ##changed to cohort MAF threshold : 3/((1585 + 3203)*2) 
...
saveRDS(res20, "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/ISKS_AR_AD/review_2/Exome_para_tab_ISKS_MGRB_C345_Jan10_m71_ccrect.rds", compress = T)
