...
##Add GCTA GRM
mat_GRM <- readRDS("~/RVAS/comb_set_2020/PC_relate/ldpruned/GCTA_GRM_ISKS_MGRB.rds")
...
#saveRDS(res20, file = "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/ISKS_AR_AD/review_doc/SKAT/Exome_skat_para_result_isks_totex_count_noPC1234_ver4_clinrect_Aug31_subPC1_grmGCTA_cpxgenes.rds", compress = T)
saveRDS(res20, file = "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/ISKS_AR_AD/review_doc/SKAT/Exome_skat_para_result_isks_totex_count_noPC1234_ver4_clinrect_Aug31_subPC1_grmGCTA.rds", compress = T)
##sanity checks
