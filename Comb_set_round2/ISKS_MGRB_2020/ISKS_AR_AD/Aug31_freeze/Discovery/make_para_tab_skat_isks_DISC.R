...
##intermediate file saved from SKAT script
...
get_coh_dist_para <- function(gene_sym, fil_db){
  ...
  res <- cbind.data.frame("ISKS_disc" = isks, "MGRB" = control, "gene" = gene_sym, 
...
saveRDS(res20, "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/ISKS_AR_AD/SKAT_disc/Exome_para_DISC_pc1234_SKAT_Enriched_ISKS_2020_Aug31_230920.rds", compress = T)
