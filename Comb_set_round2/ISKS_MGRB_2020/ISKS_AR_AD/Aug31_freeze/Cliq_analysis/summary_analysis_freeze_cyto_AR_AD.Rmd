...
#write.table(ppi_res_fil_final, #"~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/ISKS/ppi_res_fil_final.tsv#", sep = "\t", row.names = F, quote = F)
...
# strindb_graph_cyto_df <- strindb_graph_cyto_df[!grepl("^OR", strindb_graph_cyto_df$from),]
# strindb_graph_cyto_df <- strindb_graph_cyto_df[!grepl("^OR", strindb_graph_cyto_df$to),]
# strindb_graph_rect_cyto <- igraph::graph.data.frame(strindb_graph_cyto_df, directed = F)
# strindb_graph_rect_cyto1 <- igraph::simplify(strindb_graph_rect_cyto, remove.loops=T, remove.multiple = T)
...
ppi_res_fil_final_comb[ppi_res_fil_final_comb$eigen_wt_biog == 0,]$eigen_wt_biog <- sample(seq(0.00001, 0.0001, 0.001), size = 36, replace = T)
#ppi_res_fil_final_comb[ppi_res_fil_final_comb$eigen_wt_str == 0,]$eigen_wt_str <- sample(seq(0.00001, 0.0001, 0.001), size = 28, replace = T)
#ppi_res_fil_final_comb[ppi_res_fil_final_comb$eigen_wt_str_biog == 0,]$eigen_wt_str_biog <- sample(seq(0.00001, 0.0001, 0.001), size = 27, replace = T)
