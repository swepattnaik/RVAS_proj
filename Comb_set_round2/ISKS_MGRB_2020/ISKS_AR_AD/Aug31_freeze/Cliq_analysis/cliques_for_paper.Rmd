...
comb_burd_SKAT <- read.delim("~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/ISKS_AR_AD/Aug31/Cliques/Clique_OR_SKAT_968.tsv", sep = "\t", header = T, stringsAsFactors = F)
...
dend %>% plot
lab_ord <- labels(dend)
cust_col_df <- cbind.data.frame("code" = paste("Clust", 1:6, sep = "_"), "col_cust" = c("#008fd5","#de6b35", "#7a9406", "#fc0373","#8f5467", "#6c0ee8"))
