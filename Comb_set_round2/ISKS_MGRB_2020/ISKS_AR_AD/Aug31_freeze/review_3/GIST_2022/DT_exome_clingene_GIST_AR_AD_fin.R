...
Ex_tab <- read.delim("~/RVAS/GIST_32/GIST_vep_anno_32.tsv", sep = "\t",
                     header = T, stringsAsFactors = F)
...
write.table(Ex_tab_noCH_filt3_fin_filt, file = "~/RVAS/GIST_32/GIST32_variants_AR_AD_all_fields_clingene_rev3_freeze.tsv",
