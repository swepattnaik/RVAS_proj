...
#df_comb_rnd2_sub$gene <- gsub("CEP_HAUS_core", "CEP_HAUS",df_comb_rnd2_sub$gene)
#df_comb_rnd2_sub$gene <- gsub("Shelterin", "SHELTERIN",df_comb_rnd2_sub$gene)
#df_comb_rnd2_sub$gene <- gsub("SARC_genes", "SARC",df_comb_rnd2_sub$gene)
#df_comb_rnd2_sub$gene <- gsub("BRCA_genes", "BRCA",df_comb_rnd2_sub$gene)
...
# noC3_df_comb_rnd2_sub$gene <- gsub("CEP_HAUS_core", "CEP_HAUS",noC3_df_comb_rnd2_sub$gene)
# noC3_df_comb_rnd2_sub$gene <- gsub("Shelterin", "SHELTERIN",noC3_df_comb_rnd2_sub$gene)
# noC3_df_comb_rnd2_sub$gene <- gsub("SARC_genes", "SARC",noC3_df_comb_rnd2_sub$gene)
# noC3_df_comb_rnd2_sub$gene <- gsub("BRCA_genes", "BRCA",noC3_df_comb_rnd2_sub$gene)
...
##Table for intra and intercohort comparisons
```{r}
...
colnames(CI_comb_MH_meta_df_sub)[5] <- "Coh"
...
CI_comb_MH_meta_df_sub$cmpx_name <- factor(x = CI_comb_MH_meta_df_sub$cmpx_name,
                            levels = c("Centrosome geneset","Shelterin geneset", "Sarcoma geneset","TP53"), ordered = TRUE)
#TP53, Sarcoma geneset, Shelterin geneset, Centrosome geneset
CI_comb_MH_meta_df_sub$Coh <- factor(CI_comb_MH_meta_df_sub$Coh, levels = c("Rep", "Disc"))
#CI_comb_MH_meta_df_sub$shape <- ifelse(CI_comb_MH_meta_df_sub$Coh %in% "Disc", 18, 21)
p_forest <- forest_custplot(CI_comb_MH_meta_df_sub) + ggtitle("Cross validation C45") + guides(fill=guide_legend(nrow=1,byrow=TRUE)) + scale_shape_manual(values = c(15,21)) + theme(axis.text.y = element_text(face="bold", size=14)) + theme(axis.text.x = element_text(face="bold", size=14)) + theme(axis.title.x = element_text(face = "italic")) + theme(axis.line.x = element_line(color="black", size = 1)) + theme(legend.position = "top") + theme(axis.title.y = element_blank()) 
...
# ##For supp figure
CI_comb_MH_meta_C345_df_sub <- CI_comb_MH_meta_C345_df[CI_comb_MH_meta_C345_df$cmpx_name %in% c("SARC_genes","TP53_control", "Shelterin","CEP_HAUS_core"),]
...
colnames(CI_comb_MH_meta_C345_df_sub)[5] <- "Coh"
...
CI_comb_MH_meta_C345_df_sub$cmpx_name <- factor(x = CI_comb_MH_meta_C345_df_sub$cmpx_name,
                            levels = c("Centrosome geneset","Shelterin geneset", "Sarcoma geneset","TP53"), ordered = TRUE)
#TP53, Sarcoma geneset, Shelterin geneset, Centrosome geneset
CI_comb_MH_meta_C345_df_sub$Coh <- factor(CI_comb_MH_meta_C345_df_sub$Coh, levels = c("Rep", "Disc"))
#CI_comb_MH_meta_df_sub$shape <- ifelse(CI_comb_MH_meta_df_sub$Coh %in% "Disc", 18, 21)
p_forest_CV_345 <- forest_custplot(CI_comb_MH_meta_C345_df_sub) + ggtitle("Cross validation C345") + guides(fill=guide_legend(nrow=1,byrow=TRUE)) + scale_shape_manual(values = c(15,21)) + theme(axis.text.y = element_text(face="bold", size=14)) + theme(axis.text.x = element_text(face="bold", size=14)) + theme(axis.title.x = element_text(face = "italic")) + theme(axis.line.x = element_line(color="black", size = 1)) + theme(legend.position = "top") + theme(axis.title.y = element_blank()) 
...
noC3_df_comb_rnd2_sub$Coh <- gsub("ISKS200", "Test (n=1444)",noC3_df_comb_rnd2_sub$Coh)
noC3_df_comb_rnd2_sub$Coh <- gsub("rep763", "Replication (n=763)",noC3_df_comb_rnd2_sub$Coh)
...
df_comb_rnd2_sub$Coh <- gsub("ISKS200", "Test (n=1444)",df_comb_rnd2_sub$Coh)
df_comb_rnd2_sub$Coh <- gsub("rep763", "Replication (n=763)",df_comb_rnd2_sub$Coh)
