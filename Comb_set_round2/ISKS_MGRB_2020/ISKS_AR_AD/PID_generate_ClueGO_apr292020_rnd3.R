...
##Run this for AD variants and NOT AR
...
#write.table(genes, "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/ISKS/round2/CGC_topSKATBin300_repstress_potint_PID_unique_genes_rmdup_maf_cluego.txt",
#            sep = "\t", row.names = F, quote = F)
#write.table(genes, "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/ISKS/round2/CGC_topSKATBin300_repstress_potint_PID_unique_genes_rmdup_maf_cluego_may31.txt",
#            sep = "\t", row.names = F, quote = F)
...
write.table(fil_tab_PID, "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/ISKS_AR_AD/PID/CGC_topSKATBin_ISKS_MRGB_repstress_potint_VARIANTS_filt_combset2020_clueGOplus_Aug19.tsv",
            sep = "\t", row.names = F, quote = F)
...
comb_ALL_phen[,c(68:83)] <- df_sam_filt_isks_comb[match(as.character(comb_ALL_phen$pmn), df_sam_filt_isks_comb$SAMPLE), c(1:16)]
...
comb_ALL_phen[,c(85:90)] <- isks_risc_lions_chip[match(comb_ALL_phen$pmn, isks_risc_lions_chip$sample_id), c(1:6)]
...
write.table(comb_ALL_phen_filt[,-c(75:81)], 
            "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/ISKS_AR_AD/PID/PID_combset2020_CGC_skatBin_repstress_potint_predNFE_clueGO_Apr292020_AD_Aug19.tsv",
            sep = "\t", row.names = F, quote = F)
