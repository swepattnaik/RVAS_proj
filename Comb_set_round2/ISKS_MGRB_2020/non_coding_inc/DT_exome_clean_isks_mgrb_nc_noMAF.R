...
library(dplyr)
##QC
# t1 <- Ex_tab_noCH_filt3[Ex_tab_noCH_filt3$gene_symbol %in% "TERF1",]
...
##added is_case later in make_para_tab_isks_simple_nc_C2.R
...
Ex_tab_noCH_filt3_fin_filt$set <- c("nc_comb")
...
write.table(Ex_tab_noCH_filt3_fin_filt, file = "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/ISKS/round2/nc_all_isksmgrb_combset2020_variants_filt_noMAF.tsv",
