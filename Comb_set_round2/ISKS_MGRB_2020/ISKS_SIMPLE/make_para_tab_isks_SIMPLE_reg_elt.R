...
fil_tab <- read.delim("~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/ISKS/round2/reg_elt_cpx_isksmgrb_combset2020_variants_filt_noMAF_rmdup.tsv",
...
saveRDS(res20, "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/ISKS/round2/reg_elt_Exome_para_ISKS_SIMPLE_2020_C2.rds", compress = T)
