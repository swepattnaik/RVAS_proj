...
fil_tab_noCH <- read.delim("~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/ISKS/all_isksmgrb_combset2020_variants_filt_all_fields_rm_dup.tsv", sep = "\t", header = T, stringsAsFactors = F)
...
write.table(ppi_res_fil_final, "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/ISKS/round2/ppi_res_fil_final_SKATbin.tsv", sep = "\t", row.names = F, quote = F)
...
ppi_res_fil_final <- read.delim("~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/ISKS/round2/ppi_res_fil_final_SKATbin.tsv", sep = "\t", header = T)
...
write.table(ppi_res_fil_final, "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/ISKS/round2/ppi_res_fil_final_SKATbin_wt_fisher.tsv", sep = "\t", row.names = F, quote = F)
...
ppi_res_fil_final <- read.delim("~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/ISKS/round2/ppi_res_fil_final_SKATbin_wt_fisher.tsv", sep = "\t", header = T, stringsAsFactors = F)
...
saveRDS(goNet_enrich_res, file = "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/ISKS/round2/goNet_enrich_res_isks_combset2020.rds", compress = T)
...
file = "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/ISKS/round2/ISKS_combset2020_final_PPI_comb_GO.tsv", sep = "\t", row.names = F, quote = F)
