...
int_var_bed <- read.delim("~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/TCGA_SARC_AR_AD/Sarc_tcga_int_var.bed", sep = "\t",
...
saveRDS(Ex_tab, "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/TCGA_SARC_AR_AD/all_SARC_TCGA_gnomad05_pois_filt.rds", compress = T)
...
print("remove QC2 failed samples")
...
Ex_tab_noCH_filt3_fin_filt$set <- c("TCGA_SARC_AR_AD")


#write.table(Ex_tab_noCH_filt3_fin_filt, file = "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/TCGA_SARC_AR_AD/all_tcga_sarc_combset2020_variants_AR_AD_all_fields_clingene_rnd3.tsv",
#            row.names = F, quote = F, sep = "\t")
write.table(Ex_tab_noCH_filt3_fin_filt, file = "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/TCGA_SARC_AR_AD/all_tcga_sarc_combset2020_POIS_filt_variants_AR_AD_all_fields_clingene_rnd3.tsv",
            row.names = F, quote = F, sep = "\t")
