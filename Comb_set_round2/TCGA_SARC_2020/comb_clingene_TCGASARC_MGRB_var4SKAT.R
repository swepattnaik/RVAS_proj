...
##Add intra_cohort MAF filter cohort_MAF <= 0.01 for SARC & 0.0008 for  MGRB ##Added later
Ex_tab_C4C5_sarc <- Ex_tab_C4C5[Ex_tab_C4C5$cohort_MAF <= 0.01 & Ex_tab_C4C5$swegen_AF <= 0.001 & Ex_tab_C4C5$set %in% "TCGA_SARC_AR_AD",]
...
##cohort_MAF <= 0.001
Ex_tab_C3_sarc <- Ex_tab_C3[Ex_tab_C3$cohort_MAF <= 0.01 & Ex_tab_C3$swegen_AF <= 0.001 & Ex_tab_C3$set %in% "TCGA_SARC_AR_AD",]
