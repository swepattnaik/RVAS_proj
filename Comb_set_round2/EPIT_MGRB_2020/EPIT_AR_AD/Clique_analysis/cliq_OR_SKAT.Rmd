---
title: "clique detection and Fisher test"
author: "Swetansu Pattnaik"
date: "15/11/2021"
output: html_document
---

##Use Epithelial BRCA cases for clique analysis
##script is based on cliq_OR_SKAT.R script in the Cliq_analysis directory
...
ppi_res_fil_final_comb <- read.delim("~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/ISKS_AR_AD/review_doc/SKAT/isks_cyto_ppifisher_ASRB_comb_genes_totex_2021_subPC1.tsv", sep = "\t", header = T, stringsAsFactors = F)
...
saveRDS(te3, "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/ISKS_AR_AD/review_doc/Cliques/Cliques_max64_PC1_sub.rds", compress = T)

```


##Fisher's Burden test
```{r}
...
#isks_mgrb_genes <- readRDS("~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/ISKS_AR_AD/SKAT/Exome_para_tab_ISKS_MGRB_C345_Aug31.rds") ##not needed
isks_mgrb_genes_noC3 <- readRDS("~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/ISKS_AR_AD/Exome_para_tab_ISKS_MGRB_minusC3_Aug31_sub_PC1.rds")


#cpx_ISKS_OR_df <- do.call("rbind.data.frame", cpx_OR_fisher(isks_mgrb_genes, te3, 1631, 3205, "ISKSvsMGRB"))
cpx_ISKS_OR_df_noC3 <- do.call("rbind.data.frame", cpx_OR_fisher(isks_mgrb_genes_noC3, te3, 1631, 3205, "ISKSvsMGRB"))
...
fil_tab <- read.delim("~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/ISKS_AR_AD/SKAT/all_isksmgrb_skatinp_combset2020_clin_C3C4C5_NFE0002_AD_rm_dup_freeze_rev_PC1_sub.tsv", sep = "\t", stringsAsFactors = F, header = T)
...
######get phenotype data to control for age, sex, total exome count and PC's; 
...
#remove duplicates
dup_samp <- read.delim("~/RVAS/comb_set_2020/PC_relate/ldpruned/fin_samp_dup_drop.txt", sep = "", header = T,stringsAsFactors = F)
...
write.table(comb_burd_SKAT, "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/ISKS_AR_AD/review_doc/Cliques/Clique_OR_SKAT_PC1_sub.tsv",
            sep = "\t", row.names = F, quote = F)
```
