...
Ex_tab <- read.delim("~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/EPIT_AR_AD/all_shards_EPIT_combset2020_gnomad_05.tsv", sep = "\t",
...
Ex_tab_noCH_filt3_fin_filt$set <- c("EPIT_AR_AD")


write.table(Ex_tab_noCH_filt3_fin_filt, file = "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/EPIT_AR_AD/all_epit_combset2020_variants_AR_AD_all_fields_clingene_rnd3.tsv",
