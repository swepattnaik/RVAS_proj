...
#write.table(fil_tab, "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/EPIT_AR_AD/all_epitmgrb_skatinp_combset2020_rm_fmBRCA_7oeso_forTAB.tsv",
...
#  print(genes[i])
  ...
  if(dim(ftemp_tab) == 0 ){
    ...
    samp_vec_mat <- samp_vec_mat[!(as.numeric(as.character(samp_vec_mat$coh_MAF_case)) >= 0.000372 | 
                                     as.numeric(as.character(samp_vec_mat$coh_MAF_cont)) >= 0.000372),]
...
saveRDS(res_skat_para, file = "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/EPIT_AR_AD/SKAT/Exome_skat_para_result_epit_combset2020_uni_MAF_PC1234_ver4_clinrect.rds", compress = T)
