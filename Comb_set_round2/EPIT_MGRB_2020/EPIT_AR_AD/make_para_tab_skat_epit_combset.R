...
Exome_skat <- readRDS("~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/EPIT_AR_AD/SKAT/Exome_skat_para_result_epit_combset2020_uni_MAF_PC1234_ver4_clinrect.rds")
...
saveRDS(res20, "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/EPIT_AR_AD/SKAT/Exome_para_pc1234_SKAT_Enriched_EPIT_2020.rds", compress = T)
