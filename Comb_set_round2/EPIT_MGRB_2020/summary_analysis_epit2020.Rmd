...
write.table(ppi_res_fil_final, "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/EPIT/round2/ppi_res_fil_final_EPIT.tsv", sep = "\t", row.names = F, quote = F)
```
...
write.table(ppi_res_fil_final, "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/EPIT/round2/ppi_res_fil_final_EPIT_SKATbin_wt_fisher.tsv", sep = "\t", row.names = F, quote = F)
