...
Ex_tab <- read.delim("~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/NoSarc_nov2018_AR_AD/NoSarc_Nov2018_gnomad05.tsv", sep = "\t",
...
##intersect with NoSarc_Nov2018_int_var.bed
int_var_bed <- read.delim("~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/NoSarc_nov2018_AR_AD/NoSarc_Nov2018_int_var.bed", sep = "\t",
...
saveRDS(Ex_tab, "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/NoSarc_nov2018_AR_AD/all_NoSarc_Nov2018_gnomad05_pois_filt.rds", compress = T)
...
Ex_tab_noCH_filt3_fin_filt$set <- c("NOSARC_nov18_AR_AD")
...
#write.table(Ex_tab_noCH_filt3_fin_filt, file = "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/NoSarc_nov2018_AR_AD/all_nosarc_nov18_combset2020_variants_AR_AD_all_fields_clingene_rnd3.tsv",
#            row.names = F, quote = F, sep = "\t")

write.table(Ex_tab_noCH_filt3_fin_filt, file = "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/NoSarc_nov2018_AR_AD/all_nosarc_nov18_combset2020_POIS_filt_variants_AR_AD_all_fields_clingene_rnd3.tsv",
            row.names = F, quote = F, sep = "\t")
