---
title: "Summary_exome_analysis_repset"
...
Exome_skat <- readRDS("~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/Rep_set_variants/Exome_skat_wsing_load123_noCH_C5eqC4_repset_nov2019.rds")
...
Exome_pc123_srt_SKAT <- lapply(df_skat, function(x) x[order(x$pval_SKATbin, decreasing = F),])
Exome_pc123_srt_SKAT <- lapply(Exome_pc123_srt_SKAT, function(x){colnames(x)[1] <- c("symbol"); return(x)})
Exome_pc123_srt_SKAT_case_enr_nCH <- readRDS("~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/Rep_set_variants/Exome_pc123_srt_SKAT_case_enr_nCH_repset_08Oct_rect_ASP_cmaf_new_score.rds")
##Add p-value
...
fil_tab_noCH <- fil_tab_noCH[!(fil_tab_noCH$SAMPLE %in% can269$V1),]
...
#write.table(pc123_gender_tab_top1000_VAR, "/home/shu/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/Exome_Enriched_pc_gender_controlled_top_geneVARIANTS_oct08_01_repset.tsv", sep = "\t", row.names = F, quote = F)
write.table(pc123_gender_tab_top1000_VAR, "/home/shu/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/Rep_set_variants/Exome_Enriched_pc_gender_controlled_top_geneVARIANTS_oct08_02_repset.tsv",sep = "\t", row.names = F, quote = F)
