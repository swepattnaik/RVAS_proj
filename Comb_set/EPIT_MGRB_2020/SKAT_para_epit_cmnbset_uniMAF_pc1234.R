...
saveRDS(res_skat_para, file = "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/comb_set_2020/EPIT/Exome_skat_para_result_EPIT_combset2020_uni_MAF_PC1234_ver4_rect_test.rds", compress = T)
