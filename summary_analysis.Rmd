...
write.table(pc123_gender_tab_top1000_VAR, "/home/shu/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/Exome_Enriched_pc_gender_controlled_top_geneVARIANTS_sep05_ASP_cmaf01.tsv", sep = "\t", row.names = F, quote = F)
#write.table(pc123_gender_tab_top1000_VAR, "/home/shu/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/Exome_Enriched_pc_gender_controlled_top_geneVARIANTS_sep05_ASP_cmaf02.tsv",sep = "\t", row.names = F, quote = F)
...
saveRDS(goNet_enrich_res, file = "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/goNet_enrich_res_sep05_rect_ASP_01pval.rds", compress = T)
...
file = "~/RVAS/shard_sub_tier3/DT_sheet/EXOME_isks_risc/test/Sep05_rect_ASP_graph_final_PPI_comb_GO_cmaf.tsv", sep = "\t", row.names = F, quote = F)
